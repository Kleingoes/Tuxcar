...
async function seed() {
  ...
  const clientes = await Promise.all([
    post('clientes', {
      ...
      Telefono: '9611112233',
      direccion: 'Calle Central Oriente 45, Tuxtla Gutiérrez',
    ...
    post('clientes', {
      ...
      Telefono: '9619876543',
      direccion: 'Av. 5 de Mayo 230, Tuxtla Gutiérrez',
      fecha_registro: '2024-02-20T10:00:00.000Z',
      tipo: 'individual'
    }),
    post('clientes', {
      nombre: 'Transportes Chiapas SA de CV',
      correo: 'admin@transporteschiapas.com',
      Telefono: '9613344556',
      direccion: 'Blvd. Belisario Domínguez 1500, Tuxtla Gutiérrez',
      fecha_registro: '2024-03-10T10:00:00.000Z',
      tipo: 'empresa'
    }),
    post('clientes', {
      nombre: 'José Pérez Torres',
      correo: 'jose.perez@yahoo.com',
      Telefono: '9617788990',
      direccion: 'Calle 3 Sur Oriente 78, San Cristóbal de las Casas',
      fecha_registro: '2024-04-05T10:00:00.000Z',
      tipo: 'individual'
    }),
    post('clientes', {
      nombre: 'Ana González Méndez',
      correo: 'ana.gonzalez@gmail.com',
      Telefono: '9625566778',
      direccion: 'Av. Hidalgo 320, Tapachula',
      fecha_registro: '2024-05-12T10:00:00.000Z',
      tipo: 'individual'
    }),
    post('clientes', {
      nombre: 'Grupo Empresarial Olmeca',
      correo: 'compras@grupoelmeca.com',
      Telefono: '9614455667',
      direccion: 'Blvd. Andrés Serra Rojas 890, Tuxtla Gutiérrez',
  ...
  const empleados = await Promise.all([
    post('empleados', {
      ...
      puesto: 'gerente',
      telefono: '9611234001',
      correo: 'roberto.morales@autochiapas.com',
      fecha_ingreso: '2022-01-10',
      activo: true,
      concesionaria: conc1?.id
    }),
    post('empleados', {
      nombre: 'Lucía Ramírez Díaz',
      puesto: 'vendedor',
      telefono: '9611234002',
      correo: 'lucia.ramirez@autochiapas.com',
      fecha_ingreso: '2022-06-15',
      activo: true,
      concesionaria: conc1?.id
    }),
    post('empleados', {
      nombre: 'Miguel Ángel Cruz López',
      puesto: 'mecanico',
      telefono: '9611234003',
      correo: 'miguel.cruz@autochiapas.com',
      fecha_ingreso: '2023-02-01',
      activo: true,
      concesionaria: conc1?.id
    }),
    post('empleados', {
      nombre: 'Sandra Villanueva Torres',
      puesto: 'gerente',
      telefono: '9678765001',
      correo: 'sandra.villanueva@motoressureste.com',
      fecha_ingreso: '2021-08-20',
      activo: true,
      concesionaria: conc2?.id
    }),
    post('empleados', {
      nombre: 'Fernando Ochoa Jiménez',
      puesto: 'vendedor',
      telefono: '9678765002',
      correo: 'fernando.ochoa@motoressureste.com',
      fecha_ingreso: '2023-05-10',
      activo: true,
      concesionaria: conc2?.id
    }),
    post('empleados', {
      nombre: 'Patricia Solís Ruiz',
      puesto: 'administrativo',
      telefono: '9622345001',
      correo: 'patricia.solis@chiaspasmotors.com',
      fecha_ingreso: '2022-11-01',
      activo: true,
      concesionaria: conc3?.id
    }),
  ]);
  ...
  const vehiculos = await Promise.all([
    ...
    post('vehiculos', {
      ...
      estatus: 'disponible',
      disponible: true,
      numero_serie: 'VIN-TH2023-002',
      concesionaria: conc1?.id
    }),
    post('vehiculos', {
      nombre: 'Volkswagen Jetta 2021',
      marca: 'Volkswagen',
      modelo: 'Jetta',
      anio: 2021,
      color: 'Negro',
      ...
      estatus: 'disponible',
      disponible: true,
      numero_serie: 'VIN-VJ2021-003',
      concesionaria: conc1?.id
    }),
    post('vehiculos', {
      nombre: 'Chevrolet Aveo 2020',
      marca: 'Chevrolet',
      modelo: 'Aveo',
      anio: 2020,
      color: 'Rojo',
    ...
    post('vehiculos', {
      ...
      estatus: 'disponible',
      disponible: true,
      numero_serie: 'VIN-KS2022-008',
      concesionaria: conc3?.id
    }),
    post('vehiculos', {
      nombre: 'Toyota Corolla 2019',
      marca: 'Toyota',
      modelo: 'Corolla',
      anio: 2019,
      color: 'Gris',
      ...
      estatus: 'vendido',
      disponible: false,
      numero_serie: 'VIN-TC2019-009',
      concesionaria: conc1?.id
    }),
    post('vehiculos', {
      nombre: 'Nissan NP300 2021',
      marca: 'Nissan',
      modelo: 'NP300',
      anio: 2021,
      color: 'Blanco',
  ...
  const refacciones = await Promise.all([
    ...
    post('refaccions', {
      ...
      marca: 'Toyota',
      categoria: 'frenos',
      numero_refaccion: 'REF-TOY-002',
      concesionaria: conc1?.id
    }),
    post('refaccions', {
      nombre: 'Amortiguador delantero VW',
      precio: 1200,
      stock: 8,
      marca: 'Volkswagen',
      categoria: 'suspension',
      numero_refaccion: 'REF-VW-003',
      concesionaria: conc2?.id
    }),
    post('refaccions', {
      nombre: 'Batería 12V Bosch',
      precio: 1800,
      stock: 12,
      marca: 'Bosch',
      categoria: 'electrico',
      numero_refaccion: 'REF-BSC-004',
      concesionaria: conc2?.id
    }),
    post('refaccions', {
      ...
      marca: 'Bridgestone',
      categoria: 'otro',
      numero_refaccion: 'REF-BRD-005',
      concesionaria: conc3?.id
    }),
    post('refaccions', {
      nombre: 'Bujías NGK set x4',
      precio: 480,
      stock: 30,
      marca: 'NGK',
      categoria: 'motor',
      numero_refaccion: 'REF-NGK-006',
      concesionaria: conc3?.id
    }),
    post('refaccions', {
      nombre: 'Espejo retrovisor derecho Chevrolet',
      precio: 890,
      stock: 6,
      marca: 'Chevrolet',
      categoria: 'carroceria',
      numero_refaccion: 'REF-CHV-007',
      concesionaria: conc1?.id
    }),
    post('refaccions', {
      nombre: 'Filtro de aire Ford',
      precio: 320,
      stock: 18,
      marca: 'Ford',
      categoria: 'motor',
      numero_refaccion: 'REF-FRD-008',
      concesionaria: conc2?.id
    }),
  ]);
  ...
  const ventas = await Promise.all([
    post('ventas', {
      ...
      metodo_pago: 'credito',
      cantidad: 1,
      notas: 'Cliente pagó con crédito bancario BBVA',
    ...
    post('ventas', {
      ...
      cantidad: 1,
      notas: 'Empresa solicitó factura',
      clientes: clientes[2]?.id,
      vehiculo: vehiculos[1]?.id
    }),
    post('ventas', {
      fecha: '2024-05-10',
      total: 310000,
      ...
      metodo_pago: 'contado',
      cantidad: 1,
      notas: 'Venta directa en sucursal',
      clientes: clientes[1]?.id,
      vehiculo: vehiculos[2]?.id
    }),
    post('ventas', {
      fecha: '2024-06-08',
      total: 490000,
      ...
      metodo_pago: 'credito',
      cantidad: 1,
      notas: 'Pendiente aprobación de crédito',
      clientes: clientes[3]?.id,
      vehiculo: vehiculos[4]?.id
    }),
    post('ventas', {
      fecha: '2024-07-01',
      total: 420000,
      ...
      clientes: clientes[5]?.id,
      vehiculo: vehiculos[5]?.id
    }),
    post('ventas', {
      fecha: '2024-08-14',
      total: 210000,
      ...
      cantidad: 1,
      notas: '',
      clientes: clientes[4]?.id,
      vehiculo: vehiculos[8]?.id
    }),
  ]);
